...
import { useMinLimit, useMaxLimitVip, useTokenPrice, useOpenStatus, useAllowedVipBuy } from '../../state/presale/hooks'
...
export default function Whitelist() {
  ...
  const maxMimLimit = useMaxLimitVip()
  const tokenPrice = useTokenPrice()
  const isOpen = useOpenStatus()
  const isAllowed = useAllowedVipBuy(account)
  const mim = MIM[43114]
